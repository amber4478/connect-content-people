...
public class ContentRefresh extends Fragment implements SwipeRefreshLayout.OnRefreshListener
{
        ...
        new Thread()
        {
            public void run()
            {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getActivity().getBaseContext(), "Content Updated...", Toast.LENGTH_SHORT).show();
